...
var masks = {};
var inputElements = $('input[type="tel"]');
inputElements.each(function () {
  var input = $(this);
  var maskPlaceholder = input.attr('data-mask-placeholder');
  input.intlTelInput({
  ...
  input.on('countrychange', function (e) {
    ...
    if (maskNumber) {
      maskNumber = intlTelInputUtils.formatNumber(maskNumber, selectedCountry.iso2, 2);
      maskNumber = maskNumber.replace('+' + dialCode + ' ', '');
      var _mask = maskNumber.replace(/[0-9+]/ig, '0');
      input.mask(_mask, {
        placeholder: maskNumber
      });
      masks[input.attr('id')] = _mask;
    }
  });
});
$('button[type="submit"]').on('click', function (e) {
  ...
  var isValidName = nameValue !== '' && /^[a-zA-Zа-яА-Я\s]+$/.test(nameValue);
  ...
  if (isValidTelNumber && isValidName) {
    ...
    var ctaFormWrapper = $('.cta-form__wrapper');
    var contactsFormWrapper = $('.contacts-form__wrapper');
...
var _settings = settings,
  monday = _settings.monday,
  tuesday = _settings.tuesday,
  wednesday = _settings.wednesday,
  thursday = _settings.thursday,
  friday = _settings.friday;
var generateDaySkeleton = function generateDaySkeleton(day) {
  return "\n    <li class=\"occupations-list__item d-flex align-items-center\">\n        <h3 class=\"occupations-list__title text-center mb-0\">\n            ".concat(day, "\n        </h3>\n        <ul>\n            ").concat(Array(3).fill('<li class="occupation-skeleton"></li>').join(''), "\n        </ul>\n    </li>\n");
};
var generateOccupationsList = function generateOccupationsList() {
  return "\n    <ul class=\"occupations-list position-relative\">\n        ".concat([monday, tuesday, wednesday, thursday, friday].map(generateDaySkeleton).join(''), "\n    </ul>\n");
};
var occupationSkeleton = generateOccupationsList();
var loadOccupations = function loadOccupations(postId) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./menu */ "./assets/js/popup/menu.js");


/***/ }),

/***/ "./assets/js/popup/menu.js":
/*!*********************************!*\
  !*** ./assets/js/popup/menu.js ***!
  \*********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils */ "./assets/js/utils.js");
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../refs */ "./assets/js/refs.js");
...
var hamburgerButton = _refs__WEBPACK_IMPORTED_MODULE_13__["default"].hamburgerButton,
  menuBackdrop = _refs__WEBPACK_IMPORTED_MODULE_13__["default"].menuBackdrop,
...
hamburgerButton.on("click", function () {
  if (menuBackdrop.hasClass('is-hidden')) {
    ...
    (0,_utils__WEBPACK_IMPORTED_MODULE_12__.hideBackdrop)(menuBackdrop);
  }
});
menuLinks.on("click", function () {
  return (0,_utils__WEBPACK_IMPORTED_MODULE_12__.hideBackdrop)(menuBackdrop);
});
...
var teamImageSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".team-image-swiper", {
  effect: "cards",
  grabCursor: true,
  cardsEffect: {
    rotate: false,
...
$(document).ready(function () {
  var topScrollButton = $(".top-scroll");
  var scrollThreshold = 1000;
  var scrollDuration = 250;
  var handleScroll = lodash_throttle__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    var isHidden = topScrollButton.hasClass('is-hidden');
    var shouldRemoveClass = isHidden && $(window).scrollTop() >= scrollThreshold;
    var shouldAddClass = !isHidden && $(window).scrollTop() < scrollThreshold;
  ...
  topScrollButton.on("click", function () {
    $("html, body").animate({
      scrollTop: 0
    }, scrollDuration);
...
/* harmony import */ var wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! wowjs/dist/wow.min */ "./node_modules/wowjs/dist/wow.min.js");
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./refs */ "./assets/js/refs.js");





var bodyEl = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].bodyEl,
  gallerySwiper = _refs__WEBPACK_IMPORTED_MODULE_4__["default"].gallerySwiper;
...
var replaceWithDiv = function replaceWithDiv(selector, className) {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./assets/js/utils.js");
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./swiper */ "./assets/js/swiper.js");
/* harmony import */ var _loadOccupation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./loadOccupation */ "./assets/js/loadOccupation.js");
...
/* harmony import */ var _topScroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./topScroll */ "./assets/js/topScroll.js");
/* harmony import */ var _css_main_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../css/main.scss */ "./assets/css/main.scss");
